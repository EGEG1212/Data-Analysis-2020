...
"""
users = [
    ('admin', '1234', '관리자', '010-2345-6789',
     'admin@hoseo.com', '/upload/blank.png'),
    ('eskim', '1234', '김은숙', '010-9876-5432',
     'eskim@hoseo.com', '/upload/blank.png'),
    ('wjlee', '1234', '이우정', '010-3456-7890',
     'wjlee@hoseo.com', '/upload/blank.png'),
    ('djy', '1234', '대조영', '010-2323-7878', 'djy@korea.com', '/upload/blank.png'),
    ('gdhong', '1234', '홍길동', '010-9898-4567',
     'gdhong@korea.com', '/upload/blank.png')
]
...
bbsList = [
    ...
    ('eskim', '태양의 후예',
     '선 땅 극한의 환경 속에서 사랑과 성공을 꿈꾸는 젊은 군인과 의사들을 통해 삶의 가치를 담아낸 블록버스터급 휴먼 멜로 드라마'),
    ('eskim', '시크릿 가든', '가지 없는 부잣집 도련님과 스턴트맨으로 하루하루 간신히 살아가는 도시 빈민 아가씨의 연애라는 진부하기 짝이 없는 설정, 거기에 남녀의 영혼이 뒤바뀐다는 클리셰를 사용하였다.'),
    ('eskim', '파리의 연인', '''"애기야 가자"
